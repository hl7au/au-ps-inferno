...
RSpec.describe 'generated suite file basenames' do
  it 'stays within the ustar tar basename limit used by `gem build`' do
    # Scoped to lib/au_ps_inferno/generated/, not all of lib/, because the hand-authored 1.0.0
    # suite under lib/au_ps_inferno/suite/ already has file basenames over this limit and is out
    # of scope to change (see Generator::SuiteFileGenerator::LEGACY_IG_VERSION) - this spec only
    # guards the naming scheme SuiteSpec/SuiteFileGenerator use for newly generated versions.
