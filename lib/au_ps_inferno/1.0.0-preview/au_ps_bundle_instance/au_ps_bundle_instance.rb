...
module AUPSTestKit
  ...
  class AUPSSuite100previewAuPsBundleInstance < Inferno::TestGroup
    ...
    group from: :suite_100preview_au_ps_bundle_instance_patient_summary_bundle_validation_tests
    
    group from: :suite_100preview_au_ps_bundle_instance_au_ps_bundle_conformance_tests
    
    group from: :suite_100preview_au_ps_bundle_instance_au_ps_composition_conformance_tests
