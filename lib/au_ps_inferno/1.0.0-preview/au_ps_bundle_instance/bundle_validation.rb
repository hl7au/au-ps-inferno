...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceBundleValidation100preview < Inferno::TestGroup
    title 'Bundle Validation'
    description 'Validates that the bundle conforms to the Bundle profiles.'
    id :suite_au_ps_bundle_instance_bundle_validation_100preview

    run_as_group

    test from: :suite_au_ps_bundle_instance_bundle_validation_bundle_valid_100preview

    test from: :suite_au_ps_bundle_instance_bundle_validation_bundle_valid_ips_100preview
  end
end
