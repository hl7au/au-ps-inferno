...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceAuPsBundleMustSupportConformance100preview < Inferno::TestGroup
    ...
    id :suite_au_ps_bundle_instance_au_ps_bundle_must_support_conformance_100preview

    run_as_group

    test from: :suite_au_ps_bundle_instance_au_ps_bundle_must_support_conformance_bundle_must_support_populated_100preview
  end
end
