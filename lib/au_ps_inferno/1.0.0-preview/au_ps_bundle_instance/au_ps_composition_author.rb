...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceAuPsCompositionAuthor100preview < Inferno::TestGroup
    ...
    id :suite_au_ps_bundle_instance_au_ps_composition_author_100preview

    run_as_group

    test from: :suite_au_ps_bundle_instance_au_ps_composition_author_author_resource_type_is_valid_100preview

    test from: :suite_au_ps_bundle_instance_au_ps_composition_author_author_ms_elements_100preview

    test from: :suite_au_ps_bundle_instance_au_ps_composition_author_author_ms_subelements_100preview

    test from: :suite_au_ps_bundle_instance_au_ps_composition_author_author_ms_identifier_slices_100preview
  end
end
