...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceBundleValidationBundleIsValidAgainstAuPsBundle100preview < BundleIsValidClass
    ...
    id :suite_au_ps_bundle_instance_bundle_validation_bundle_valid_100preview
