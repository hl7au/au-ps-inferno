...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceBundleValidationBundleIsValidAgainstIpsBundle100preview < IpsBundleIsValidClass
    ...
    id :suite_au_ps_bundle_instance_bundle_validation_bundle_valid_ips_100preview
