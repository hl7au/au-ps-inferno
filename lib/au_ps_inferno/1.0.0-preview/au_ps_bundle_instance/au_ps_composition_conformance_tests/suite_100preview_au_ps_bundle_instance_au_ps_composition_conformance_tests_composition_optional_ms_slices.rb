...
module AUPSTestKit
  ...
  class AUPSSuite100previewAuPsBundleInstanceAuPsCompositionConformanceTestsMustSupportSlicedElementsAreCorrectlyPopulated < BasicTest
    ...
    id :suite_100preview_au_ps_bundle_instance_au_ps_composition_conformance_tests_composition_optional_ms_slices
