...
module AUPSTestKit
  ...
  class AUPSSuite100previewAuPsBundleInstanceAuPsCompositionConformanceTestsMustSupportSubelementsOfAComplexElementAreCorrectlyPopulated < BasicTest
    ...
    id :suite_100preview_au_ps_bundle_instance_au_ps_composition_conformance_tests_composition_ms_subelements_populated
