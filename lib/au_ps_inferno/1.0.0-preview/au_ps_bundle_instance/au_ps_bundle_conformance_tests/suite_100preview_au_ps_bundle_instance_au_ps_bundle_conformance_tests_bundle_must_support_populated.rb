...
module AUPSTestKit
  ...
  class AUPSSuite100previewAuPsBundleInstanceAuPsBundleConformanceTestsAuPsBundleMustSupportElementsAreCorrectlyPopulated < BasicTest
    ...
    id :suite_100preview_au_ps_bundle_instance_au_ps_bundle_conformance_tests_bundle_must_support_populated
