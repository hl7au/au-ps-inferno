...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceAuPsCompositionMandatorySections100preview < Inferno::TestGroup
    ...
    id :suite_au_ps_bundle_instance_au_ps_composition_mandatory_sections_100preview

    run_as_group

    test from: :suite_au_ps_bundle_instance_au_ps_composition_mandatory_sections_sections_shall_populated_100preview

    test from: :suite_au_ps_bundle_instance_au_ps_composition_mandatory_sections_mandatory_sections_entry_profiles_100preview
  end
end
