...
module AUPSTestKit
  # Automatically generated test for Medical Devices section validation
  class AUPSSectionsMedicalDevicesValidation100preview < BasicTest
    title 'Validate Medical Devices Section References and Resources'
    description 'Validates that the Medical Devices section in the Composition resource contains valid ' \
    ...
    id :au_ps_sections_medical_devices_validation_100preview
    optional true
