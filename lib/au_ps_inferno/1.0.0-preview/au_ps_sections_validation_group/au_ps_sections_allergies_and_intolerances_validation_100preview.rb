...
module AUPSTestKit
  # Automatically generated test for Allergies and Intolerances section validation
  class AUPSSectionsAllergiesandIntolerancesValidation100preview < BasicTest
    title 'Validate Allergies and Intolerances Section References and Resources'
    description 'Validates that the Allergies and Intolerances section in the Composition resource contains valid ' \
    ...
    id :au_ps_sections_allergies_and_intolerances_validation_100preview
    optional false
