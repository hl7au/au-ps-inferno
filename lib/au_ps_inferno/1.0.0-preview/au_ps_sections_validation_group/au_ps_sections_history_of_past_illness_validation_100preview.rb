...
module AUPSTestKit
  ...
  class AUPSSectionsHistoryofPastIllnessValidation100preview < BasicTest
    ...
    id :au_ps_sections_history_of_past_illness_validation_100preview
    optional true
    ...
    run do
      ...
      read_and_save_data
      validate_section_resources('Composition.section:sectionPastProblems')
    end
  end
end
