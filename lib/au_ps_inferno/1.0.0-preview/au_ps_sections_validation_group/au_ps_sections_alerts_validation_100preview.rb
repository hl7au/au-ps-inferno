...
module AUPSTestKit
  # Automatically generated test for Alerts section validation
  class AUPSSectionsAlertsValidation100preview < BasicTest
    title 'Validate Alerts Section References and Resources'
    description 'Validates that the Alerts section in the Composition resource contains valid ' \
    ...
    id :au_ps_sections_alerts_validation_100preview
    optional true
