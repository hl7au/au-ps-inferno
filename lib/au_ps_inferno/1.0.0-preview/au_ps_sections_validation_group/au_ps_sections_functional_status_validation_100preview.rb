...
module AUPSTestKit
  # Automatically generated test for Functional Status section validation
  class AUPSSectionsFunctionalStatusValidation100preview < BasicTest
    title 'Validate Functional Status Section References and Resources'
    description 'Validates that the Functional Status section in the Composition resource contains valid ' \
    ...
    id :au_ps_sections_functional_status_validation_100preview
    optional true
