...
module AUPSTestKit
  # Automatically generated test for Medication Summary section validation
  class AUPSSectionsMedicationSummaryValidation100preview < BasicTest
    title 'Validate Medication Summary Section References and Resources'
    description 'Validates that the Medication Summary section in the Composition resource contains valid ' \
    ...
    id :au_ps_sections_medication_summary_validation_100preview
    optional false
