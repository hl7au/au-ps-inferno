...
module AUPSTestKit
  ...
  class AUPSSuiteGenerateAuPsUsingIpsSummaryValidationTestsAuPsCompositionRecommendedSectionsAuPsCompositionRecommendedSectionsAreCorrectlyPopulated100preview < BasicTest
    ...
    id :suite_generate_au_ps_using_ips_summary_validation_tests_au_ps_composition_recommended_sections_sections_should_populated_100preview
