...
module AUPSTestKit
  ...
  class AUPSSuite100previewGenerateAuPsUsingIpsSummaryValidationTestsAuPsCompositionConformanceTestsOptionalMustSupportElementsAreCorrectlyPopulated < BasicTest
    ...
    id :suite_100preview_generate_au_ps_using_ips_summary_validation_tests_au_ps_composition_conformance_tests_composition_optional_ms_populated
