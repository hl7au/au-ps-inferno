...
module AUPSTestKit
  ...
  class AUPSSuite100previewGenerateAuPsUsingIpsSummaryValidationTestsAuPsBundleConformanceTestsAuPsBundleMustSupportElementsAreCorrectlyPopulated < BasicTest
    ...
    id :suite_100preview_generate_au_ps_using_ips_summary_validation_tests_au_ps_bundle_conformance_tests_bundle_must_support_populated
