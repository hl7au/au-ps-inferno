...
module AUPSTestKit
  ...
  class AUPSRetrieveBundleGroup100preview < Inferno::TestGroup
    ...
    id :au_ps_retrieve_bundle_group_100preview

    run_as_group

    
    test from: :au_ps_retrieve_valid_bundle_100preview
    
    test from: :au_ps_retrieve_bundle_has_must_support_elements_100preview
    
    test from: :au_ps_retrieve_bundle_composition_must_support_elements_100preview
    
    test from: :au_ps_retrieve_bundle_composition_mandatory_sections_100preview
    
    test from: :au_ps_retrieve_bundle_composition_recommended_sections_100preview
    
    test from: :au_ps_retrieve_bundle_composition_optional_sections_100preview
    
    test from: :au_ps_retrieve_bundle_composition_other_sections_100preview
