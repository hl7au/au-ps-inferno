...
module AUPSTestKit
  ...
  class AUPSSuite100previewRetrieveAuPsBundleValidationTestsAuPsCompositionCustodianMustSupportElementsIncludingSubelementsShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :suite_100preview_retrieve_au_ps_bundle_validation_tests_au_ps_composition_custodian_custodian_ms_elements
