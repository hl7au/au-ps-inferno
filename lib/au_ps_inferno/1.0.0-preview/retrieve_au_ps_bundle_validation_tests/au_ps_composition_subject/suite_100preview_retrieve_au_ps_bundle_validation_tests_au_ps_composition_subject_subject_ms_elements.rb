...
module AUPSTestKit
  ...
  class AUPSSuite100previewRetrieveAuPsBundleValidationTestsAuPsCompositionSubjectMustSupportElementsIncludingSubelementsShallBePopulatedIfAValueIsKnown < BasicTest
