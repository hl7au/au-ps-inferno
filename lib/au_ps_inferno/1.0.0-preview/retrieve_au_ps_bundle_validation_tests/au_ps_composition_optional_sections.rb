...
module AUPSTestKit
  ...
  class AUPSSuiteRetrieveAuPsBundleValidationTestsAuPsCompositionOptionalSections100preview < Inferno::TestGroup
    ...
    id :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_optional_sections_100preview

    run_as_group

    test from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_optional_sections_sections_may_populated_100preview

    test from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_optional_sections_optional_sections_entry_profiles_100preview
  end
end
