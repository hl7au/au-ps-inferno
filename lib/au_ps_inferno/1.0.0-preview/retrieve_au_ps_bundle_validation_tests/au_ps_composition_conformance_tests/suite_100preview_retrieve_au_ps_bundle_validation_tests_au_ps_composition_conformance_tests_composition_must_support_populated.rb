...
module AUPSTestKit
  ...
  class AUPSSuite100previewRetrieveAuPsBundleValidationTestsAuPsCompositionConformanceTestsCompositionMustSupportElementsAreCorrectlyPopulated < BasicTest
    ...
    id :suite_100preview_retrieve_au_ps_bundle_validation_tests_au_ps_composition_conformance_tests_composition_must_support_populated
