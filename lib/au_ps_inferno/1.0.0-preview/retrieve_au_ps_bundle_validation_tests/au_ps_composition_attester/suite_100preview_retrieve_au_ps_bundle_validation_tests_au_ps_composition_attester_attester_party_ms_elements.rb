...
module AUPSTestKit
  ...
  class AUPSSuite100previewRetrieveAuPsBundleValidationTestsAuPsCompositionAttesterMustSupportElementsIncludingSubelementsShallBePopulatedIfAValueIsKnown < BasicTest
