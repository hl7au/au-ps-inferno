...
module AUPSTestKit
  ...
  class AUPSSuiteRetrieveAuPsBundleValidationTestsAuPsCompositionUndefinedSections100preview < Inferno::TestGroup
    ...
    id :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_undefined_sections_100preview

    optional

    run_as_group

    test from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_undefined_sections_sections_may_undefined_100preview
  end
end
