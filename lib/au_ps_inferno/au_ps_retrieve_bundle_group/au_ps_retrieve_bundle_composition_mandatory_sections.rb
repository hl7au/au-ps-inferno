...
module AUPSTestKit
  class AUPSRetrieveBundleCompositionMandatorySection < BasicTest
    title TEXTS[:au_ps_retrieve_bundle_composition_mandatory_sections][:title]
    description TEXTS[:au_ps_retrieve_bundle_composition_mandatory_sections][:description]
