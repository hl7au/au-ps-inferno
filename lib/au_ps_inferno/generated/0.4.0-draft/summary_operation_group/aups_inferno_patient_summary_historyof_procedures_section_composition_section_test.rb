...
module AUPSTestKit
  class AUPSInfernoPatientSummaryHistoryofProceduresSectionCompositionSectionTest < Inferno::Test
    title 'Validate Patient Summary History of Procedures Section'
    description 'This test verifies that the Patient Summary History of Procedures Section within the Composition entry of a $summary Bundle is correctly structured. It extracts the references listed in the section, checks that the corresponding resources exist in the Bundle, and ensures they conform to the expected resource type and profile requirements.'
    id :au_ps_patient_summary_history_of_procedures_section_composition_section_test
    ...
    run do
      ...
      current_section = composition_resource.section.find { |s| s.code.coding.first.code == '47519-4' }
      ...
      target_resources_and_profiles = 'Procedure::http://hl7.org.au/fhir/ps/StructureDefinition/au-ps-procedure'.split(';').map do |segment|
