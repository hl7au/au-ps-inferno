...
module AUPSTestKit
  class AUPSInfernoPatientSummarySocialHistorySectionCompositionSectionTest < Inferno::Test
    title 'Validate Patient Summary Social History Section'
    description 'This test verifies that the Patient Summary Social History Section within the Composition entry of a $summary Bundle is correctly structured. It extracts the references listed in the section, checks that the corresponding resources exist in the Bundle, and ensures they conform to the expected resource type and profile requirements.'
    id :au_ps_patient_summary_social_history_section_composition_section_test
    ...
    run do
      ...
      current_section = composition_resource.section.find { |s| s.code.coding.first.code == '29762-2' }
      ...
      target_resources_and_profiles = 'Observation::http://hl7.org.au/fhir/ps/StructureDefinition/au-ps-smokingstatus;Observation::http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-alcoholuse-uv-ips'.split(';').map do |segment|
