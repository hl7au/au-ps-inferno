...
module AUPSTestKit
  class AUPSInfernoPatientSummaryAlertsSectionCompositionSectionTest < Inferno::Test
    title 'Validate Patient Summary Alerts Section'
    description 'This test verifies that the Patient Summary Alerts Section within the Composition entry of a $summary Bundle is correctly structured. It extracts the references listed in the section, checks that the corresponding resources exist in the Bundle, and ensures they conform to the expected resource type and profile requirements.'
    id :au_ps_patient_summary_alerts_section_composition_section_test
