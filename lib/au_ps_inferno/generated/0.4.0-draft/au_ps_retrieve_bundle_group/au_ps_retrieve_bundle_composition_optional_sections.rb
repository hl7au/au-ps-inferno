...
module AUPSTestKit
  class AUPSRetrieveBundleCompositionOptionalSection < BasicTest
    title TEXTS[:au_ps_retrieve_bundle_composition_optional_sections][:title]
    description TEXTS[:au_ps_retrieve_bundle_composition_optional_sections][:description]
