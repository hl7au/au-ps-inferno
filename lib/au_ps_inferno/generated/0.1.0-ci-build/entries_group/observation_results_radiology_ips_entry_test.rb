...
module AUPSTestKit
  class ObservationResultsRadiologyIpsEntryTest < Inferno::TestGroup
    title 'Observation Results - Radiology (IPS)'
    description 'TODO description: ObservationResultsRadiologyIpsEntryTest'
    ...
    test do
      ...
      run do
        ...
        skip_if existing_resources.empty?,
                "No existing resources of type 'Observation' with profile 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-results-radiology-uv-ips' found."
