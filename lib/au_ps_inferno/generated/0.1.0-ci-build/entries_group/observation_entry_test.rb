...
module AUPSTestKit
  class ObservationEntryTest < Inferno::TestGroup
    title 'Observation'
    description 'TODO description: ObservationEntryTest'
    ...
    test do
      ...
      run do
        ...
        skip_if existing_resources.empty?,
                "No existing resources of type 'Observation' with profile 'http://hl7.org/fhir/StructureDefinition/vitalsigns' found."
