...
module AUPSTestKit
  class ObservationSocialHistoryAlcoholUseIpsEntryTest < Inferno::Test
    ...
    run do
      ...
      skip_if existing_resources.empty?, "No existing resources of type 'Observation' with profile 'http://hl7.org/fhir/uv/ips/StructureDefinition/Observation-alcoholuse-uv-ips' found."
