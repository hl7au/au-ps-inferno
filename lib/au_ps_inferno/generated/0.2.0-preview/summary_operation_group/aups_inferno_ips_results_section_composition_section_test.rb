...
module AUPSTestKit
  class AUPSInfernoIPSResultsSectionCompositionSectionTest < Inferno::Test
    title 'Validate IPS Results Section'
    description 'This test verifies that the IPS Results Section within the Composition entry of a $summary Bundle is correctly structured. It extracts the references listed in the section, checks that the corresponding resources exist in the Bundle, and ensures they conform to the expected resource type and profile requirements.'
    id :au_ps_ips_results_section_composition_section_test
