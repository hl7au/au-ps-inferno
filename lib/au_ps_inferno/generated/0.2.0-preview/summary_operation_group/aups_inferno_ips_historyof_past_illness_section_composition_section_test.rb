...
module AUPSTestKit
  class AUPSInfernoIPSHistoryofPastIllnessSectionCompositionSectionTest < Inferno::Test
    ...
    id :au_ps_ips_history_of_past_illness_section_composition_section_test
