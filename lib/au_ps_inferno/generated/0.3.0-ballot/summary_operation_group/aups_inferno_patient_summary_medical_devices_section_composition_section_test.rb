...
module AUPSTestKit
  class AUPSInfernoPatientSummaryMedicalDevicesSectionCompositionSectionTest < Inferno::Test
    title 'Validate Patient Summary Medical Devices Section'
    description 'This test verifies that the Patient Summary Medical Devices Section within the Composition entry of a $summary Bundle is correctly structured. It extracts the references listed in the section, checks that the corresponding resources exist in the Bundle, and ensures they conform to the expected resource type and profile requirements.'
    id :au_ps_patient_summary_medical_devices_section_composition_section_test
    ...
    run do
      ...
      current_section = composition_resource.section.find { |s| s.code.coding.first.code == '46264-8' }
      ...
      target_resources_and_profiles = 'DeviceUseStatement::http://hl7.org/fhir/uv/ips/StructureDefinition/DeviceUseStatement-uv-ips'.split(';').map do |segment|
