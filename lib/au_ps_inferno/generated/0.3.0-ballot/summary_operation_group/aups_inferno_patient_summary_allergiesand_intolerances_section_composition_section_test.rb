...
module AUPSTestKit
  class AUPSInfernoPatientSummaryAllergiesandIntolerancesSectionCompositionSectionTest < Inferno::Test
    title 'Validate Patient Summary Allergies and Intolerances Section'
    description 'This test verifies that the Patient Summary Allergies and Intolerances Section within the Composition entry of a $summary Bundle is correctly structured. It extracts the references listed in the section, checks that the corresponding resources exist in the Bundle, and ensures they conform to the expected resource type and profile requirements.'
    id :au_ps_patient_summary_allergies_and_intolerances_section_composition_section_test
