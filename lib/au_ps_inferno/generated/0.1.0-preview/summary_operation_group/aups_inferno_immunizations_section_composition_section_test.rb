...
module AUPSTestKit
  class AUPSInfernoImmunizationsSectionCompositionSectionTest < Inferno::Test
    title 'Validate Immunizations Section'
    description 'This test verifies that the Immunizations Section within the Composition entry of a $summary Bundle is correctly structured. It extracts the references listed in the section, checks that the corresponding resources exist in the Bundle, and ensures they conform to the expected resource type and profile requirements.'
    id :au_ps_immunizations_section_composition_section_test
