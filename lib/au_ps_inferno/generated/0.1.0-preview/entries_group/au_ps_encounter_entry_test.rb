...
module AUPSTestKit
  class AuPsEncounterEntryTest < Inferno::Test
    ...
    run do
      ...
      skip_if existing_resources.empty?, "No existing resources of type 'Encounter' with profile 'http://hl7.org.au/fhir/ps/StructureDefinition/au-ps-encounter' found."
