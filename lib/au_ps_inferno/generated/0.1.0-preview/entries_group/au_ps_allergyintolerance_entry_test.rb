...
module AUPSTestKit
  class AuPsAllergyintoleranceEntryTest < Inferno::Test
    ...
    run do
      ...
      skip_if existing_resources.empty?, "No existing resources of type 'AllergyIntolerance' with profile 'http://hl7.org.au/fhir/ps/StructureDefinition/au-ps-allergyintolerance' found."
