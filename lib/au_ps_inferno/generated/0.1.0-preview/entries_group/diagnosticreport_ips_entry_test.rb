...
module AUPSTestKit
  class DiagnosticreportIpsEntryTest < Inferno::Test
    ...
    run do
      ...
      skip_if existing_resources.empty?, "No existing resources of type 'DiagnosticReport' with profile 'http://hl7.org/fhir/uv/ips/StructureDefinition/DiagnosticReport-uv-ips' found."
