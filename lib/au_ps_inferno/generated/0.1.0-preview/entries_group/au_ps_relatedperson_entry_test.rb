...
module AUPSTestKit
  class AuPsRelatedpersonEntryTest < Inferno::Test
    ...
    run do
      ...
      skip_if existing_resources.empty?, "No existing resources of type 'RelatedPerson' with profile 'http://hl7.org.au/fhir/ps/StructureDefinition/au-ps-relatedperson' found."
