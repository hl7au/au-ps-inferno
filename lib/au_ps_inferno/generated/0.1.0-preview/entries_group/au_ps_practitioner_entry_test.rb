...
module AUPSTestKit
  class AuPsPractitionerEntryTest < Inferno::Test
    ...
    run do
      ...
      skip_if existing_resources.empty?, "No existing resources of type 'Practitioner' with profile 'http://hl7.org.au/fhir/ps/StructureDefinition/au-ps-practitioner' found."
