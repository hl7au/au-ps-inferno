...
module AUPSTestKit
  ...
  class AUPSSectionsHistoryofProceduresValidation100ballot < BasicTest
    ...
    id :au_ps_sections_history_of_procedures_validation_100ballot
    optional true
    ...
    run do
      ...
      read_and_save_data
      validate_section_resources({"code"=>"47519-4", "display"=>"Patient Summary History of Procedures Section", "resources"=>{"Procedure|http://hl7.org.au/fhir/ps/StructureDefinition/au-ps-procedure"=>{"requirements"=>[]}}})
    end
  end
end
