...
module AUPSTestKit
  ...
  class AUPSSuite100ballotGeneratedBundleIpsSummaryCompositionRecommendedSectionsSectionsShouldBeCorrectlyPopulatedIfAValueIsKnown < BasicTest
    ...
    id :suite_100ballot_generated_bundle_ips_summary_composition_recommended_sections_sections_should_be_correctly_populated_if_a_value_is_known
