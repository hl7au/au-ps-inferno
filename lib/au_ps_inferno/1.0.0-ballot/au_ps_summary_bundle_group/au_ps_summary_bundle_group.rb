...
module AUPSTestKit
  ...
  class AUPSSummaryBundleGroup100ballot < Inferno::TestGroup
    ...
    id :au_ps_summary_bundle_group_100ballot
    ...
    test from: :au_ps_summary_valid_bundle_100ballot
    
    test from: :au_ps_summary_bundle_has_must_support_elements_100ballot
    
    test from: :au_ps_summary_bundle_composition_must_support_elements_100ballot
    
    test from: :au_ps_summary_bundle_composition_mandatory_sections_100ballot
    
    test from: :au_ps_summary_bundle_composition_recommended_sections_100ballot
    
    test from: :au_ps_summary_bundle_composition_optional_sections_100ballot
    
    test from: :au_ps_summary_bundle_composition_other_sections_100ballot
