...
module AUPSTestKit
  ...
  class AUPSSuite100ballotRetrievedBundleCompositionUndefinedSectionsSectionsMayBePopulated < BasicTest
    ...
    id :suite_100ballot_retrieved_bundle_composition_undefined_sections_sections_may_be_populated
