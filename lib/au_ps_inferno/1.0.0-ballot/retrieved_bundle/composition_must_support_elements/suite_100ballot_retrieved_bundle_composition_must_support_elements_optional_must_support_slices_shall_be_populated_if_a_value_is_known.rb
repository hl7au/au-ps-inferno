...
module AUPSTestKit
  ...
  class AUPSSuite100ballotRetrievedBundleCompositionMustSupportElementsOptionalMustSupportSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :suite_100ballot_retrieved_bundle_composition_must_support_elements_optional_must_support_slices_shall_be_populated_if_a_value_is_known
