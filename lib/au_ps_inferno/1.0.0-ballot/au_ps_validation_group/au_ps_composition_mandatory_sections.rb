...
module AUPSTestKit
  ...
  class AUPSCompositionMandatorySection100ballot < BasicTest
    ...
    id :au_ps_composition_mandatory_sections_100ballot

    
    run do
      read_composition_sections_info(["11450-4", "48765-2", "10160-0"])
    end
