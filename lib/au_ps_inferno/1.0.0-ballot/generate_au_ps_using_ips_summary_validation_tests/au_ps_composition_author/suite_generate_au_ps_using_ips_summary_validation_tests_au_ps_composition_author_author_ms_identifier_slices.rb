...
module AUPSTestKit
  ...
  class AUPSSuiteGenerateAuPsUsingIpsSummaryValidationTestsAuPsCompositionAuthorMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown100ballot < BasicTest
    ...
    id :suite_generate_au_ps_using_ips_summary_validation_tests_au_ps_composition_author_author_ms_identifier_slices_100ballot
