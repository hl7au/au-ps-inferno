...
module AUPSTestKit
  ...
  class AUPSSuiteGenerateAuPsUsingIpsSummaryValidationTestsAuPsBundleMustSupportConformanceAuPsBundleMustSupportElementsAreCorrectlyPopulated100ballot < BasicTest
    ...
    id :suite_generate_au_ps_using_ips_summary_validation_tests_au_ps_bundle_must_support_conformance_bundle_must_support_populated_100ballot
