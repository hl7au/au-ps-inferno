...
module AUPSTestKit
  ...
  class AUPSSuite100ballotGenerateAuPsUsingIpsSummaryValidationTestsAuPsCompositionUndefinedSectionsSectionsMayBePopulated < BasicTest
    ...
    id :suite_100ballot_generate_au_ps_using_ips_summary_validation_tests_au_ps_composition_undefined_sections_sections_may_be_populated
