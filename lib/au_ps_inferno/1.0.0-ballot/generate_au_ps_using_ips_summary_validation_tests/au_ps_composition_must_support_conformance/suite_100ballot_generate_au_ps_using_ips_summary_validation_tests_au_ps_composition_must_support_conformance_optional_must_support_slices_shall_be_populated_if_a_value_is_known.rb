...
module AUPSTestKit
  ...
  class AUPSSuite100ballotGenerateAuPsUsingIpsSummaryValidationTestsAuPsCompositionMustSupportConformanceOptionalMustSupportSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :suite_100ballot_generate_au_ps_using_ips_summary_validation_tests_au_ps_composition_must_support_conformance_optional_must_support_slices_shall_be_populated_if_a_value_is_known
