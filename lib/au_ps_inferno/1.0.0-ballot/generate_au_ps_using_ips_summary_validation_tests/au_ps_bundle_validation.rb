...
module AUPSTestKit
  ...
  class AUPSSuite100ballotGenerateAuPsUsingIpsSummaryValidationTestsAuPsBundleValidation < Inferno::TestGroup
    title 'AU PS Bundle Validation'
    description 'Validates that the bundle conforms to the AU PS Bundle profile.'
    id :suite_100ballot_generate_au_ps_using_ips_summary_validation_tests_au_ps_bundle_validation
