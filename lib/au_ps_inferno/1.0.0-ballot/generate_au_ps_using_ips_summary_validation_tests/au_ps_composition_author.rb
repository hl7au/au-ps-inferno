...
require_relative 'au_ps_composition_author/suite_100ballot_generate_au_ps_using_ips_summary_validation_tests_au_ps_composition_author_author_resource_type_is_valid'
...
require_relative 'au_ps_composition_author/suite_100ballot_generate_au_ps_using_ips_summary_validation_tests_au_ps_composition_author_author_ms_identifier_slices'
...
module AUPSTestKit
  ...
  class AUPSSuite100ballotGenerateAuPsUsingIpsSummaryValidationTestsAuPsCompositionAuthor < Inferno::TestGroup
    ...
    test from: :suite_100ballot_generate_au_ps_using_ips_summary_validation_tests_au_ps_composition_author_author_resource_type_is_valid
    ...
    test from: :suite_100ballot_generate_au_ps_using_ips_summary_validation_tests_au_ps_composition_author_author_ms_identifier_slices
