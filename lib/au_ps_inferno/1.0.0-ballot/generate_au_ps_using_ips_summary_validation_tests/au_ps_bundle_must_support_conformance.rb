...
module AUPSTestKit
  ...
  class AUPSSuite100ballotGenerateAuPsUsingIpsSummaryValidationTestsAuPsBundleMustSupportConformance < Inferno::TestGroup
    ...
    id :suite_100ballot_generate_au_ps_using_ips_summary_validation_tests_au_ps_bundle_must_support_conformance
