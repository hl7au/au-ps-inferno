...
module AUPSTestKit
  ...
  class AUPSSuiteGenerateAuPsUsingIpsSummaryValidationTestsAuPsCompositionCustodianMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown100ballot < BasicTest
    ...
    id :suite_generate_au_ps_using_ips_summary_validation_tests_au_ps_composition_custodian_custodian_ms_identifier_slices_100ballot
