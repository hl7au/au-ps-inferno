...
module AUPSTestKit
  # Automatically generated top-level test suite for the AU PS 1.0.0-ballot implementation guide.
  class AUPSSuite100ballot < Inferno::TestSuite
    ...
    description 'Validates AU PS (Australian Primary Care and Shared Health) bundles, ' \
                ...
                '1.0.0-ballot implementation guide.'
    ...
    group from: :suite_au_ps_bundle_instance_100ballot

    group from: :au_ps_retrieve_cs_group_100ballot

    group from: :suite_retrieve_au_ps_bundle_validation_tests_100ballot

    group from: :suite_generate_au_ps_using_ips_summary_validation_tests_100ballot
