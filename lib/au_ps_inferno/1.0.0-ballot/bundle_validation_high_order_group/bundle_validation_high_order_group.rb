...
module AUPSTestKit
  ...
  class BundleValidationHighOrderGroup < Inferno::TestGroup
    ...
    group from: :bundle_validation_bundle_has_must_support_elements_generic_bundle_group
    
    group from: :bundle_validation_composition_must_support_elements_generic_bundle_group
    
    group from: :bundle_validation_composition_mandatory_sections_generic_bundle_group
    
    group from: :bundle_validation_composition_recommended_sections_generic_bundle_group
    
    group from: :bundle_validation_composition_optional_sections_generic_bundle_group
    
    group from: :bundle_validation_composition_other_sections_generic_bundle_group
