...
module AUPSTestKit
  ...
  class AUPSSuite100ballotGenerateBundleUsingIpsSummaryValidationCompositionUndefinedSectionsSectionsMayBePopulated < BasicTest
    title 'Sections MAY be populated'
    description ''
    id :suite_100ballot_generate_bundle_using_ips_summary_validation_composition_undefined_sections_sections_may_be_populated
