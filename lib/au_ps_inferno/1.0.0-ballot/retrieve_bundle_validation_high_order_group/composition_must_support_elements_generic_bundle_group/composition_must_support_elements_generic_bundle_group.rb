...
module AUPSTestKit
  ...
  class CompositionMustSupportElementsGenericBundleGroup < Inferno::TestGroup
    ...
    id :retrieve_bundle_validation_composition_must_support_elements_generic_bundle_group
