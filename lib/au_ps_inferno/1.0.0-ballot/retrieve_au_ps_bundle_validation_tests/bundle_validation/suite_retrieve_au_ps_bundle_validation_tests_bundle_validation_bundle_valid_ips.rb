...
module AUPSTestKit
  ...
  class AUPSSuiteRetrieveAuPsBundleValidationTestsBundleValidationRetrievedBundleIsValidAgainstIpsBundleProfile100ballot < IpsRetrieveBundleTestClass
    ...
    id :suite_retrieve_au_ps_bundle_validation_tests_bundle_validation_bundle_valid_ips_100ballot
