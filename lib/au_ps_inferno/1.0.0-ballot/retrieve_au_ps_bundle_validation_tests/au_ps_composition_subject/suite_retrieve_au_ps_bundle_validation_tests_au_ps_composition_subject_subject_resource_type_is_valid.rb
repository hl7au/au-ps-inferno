...
module AUPSTestKit
  ...
  class AUPSSuiteRetrieveAuPsBundleValidationTestsAuPsCompositionSubjectSubjectReferenceInTheAuPsCompositionShallResolveToAValidResourceTypePatient100ballot < BasicTest
    ...
    id :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_subject_subject_resource_type_is_valid_100ballot
