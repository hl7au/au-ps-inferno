...
module AUPSTestKit
  ...
  class AUPSSuite100ballotRetrieveAuPsBundleValidationTestsAuPsCompositionSubjectSubjectReferenceInTheAuPsCompositionShallResolveToAValidResourceTypePatient < BasicTest
    ...
    id :suite_100ballot_retrieve_au_ps_bundle_validation_tests_au_ps_composition_subject_subject_resource_type_is_valid
