...
module AUPSTestKit
  ...
  class AUPSSuiteRetrieveAuPsBundleValidationTestsAuPsCompositionAttester100ballot < Inferno::TestGroup
    ...
    id :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_attester_100ballot

    optional

    run_as_group

    test from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_attester_attester_party_ms_elements_100ballot

    test from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_attester_attester_party_ms_subelements_100ballot

    test from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_attester_attester_party_ms_identifier_slices_100ballot
  end
end
