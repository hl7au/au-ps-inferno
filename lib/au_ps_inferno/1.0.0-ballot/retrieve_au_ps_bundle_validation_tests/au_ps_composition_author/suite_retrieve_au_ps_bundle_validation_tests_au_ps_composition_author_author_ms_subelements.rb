...
module AUPSTestKit
  ...
  class AUPSSuiteRetrieveAuPsBundleValidationTestsAuPsCompositionAuthorMustSupportSubelementsShallBePopulatedIfAValueIsKnown100ballot < BasicTest
    ...
    id :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_author_author_ms_subelements_100ballot
