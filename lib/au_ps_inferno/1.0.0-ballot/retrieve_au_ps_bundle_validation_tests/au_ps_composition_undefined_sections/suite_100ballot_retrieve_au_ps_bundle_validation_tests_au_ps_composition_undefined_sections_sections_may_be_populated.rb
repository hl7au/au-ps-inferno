...
module AUPSTestKit
  ...
  class AUPSSuite100ballotRetrieveAuPsBundleValidationTestsAuPsCompositionUndefinedSectionsSectionsMayBePopulated < BasicTest
    ...
    id :suite_100ballot_retrieve_au_ps_bundle_validation_tests_au_ps_composition_undefined_sections_sections_may_be_populated
