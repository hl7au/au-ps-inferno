...
module AUPSTestKit
  ...
  class AUPSSuite100ballotRetrieveAuPsBundleValidationTestsAuPsCompositionRecommendedSectionsSectionsShouldBeCorrectlyPopulatedIfAValueIsKnown < BasicTest
    ...
    id :suite_100ballot_retrieve_au_ps_bundle_validation_tests_au_ps_composition_recommended_sections_sections_should_be_correctly_populated_if_a_value_is_known
