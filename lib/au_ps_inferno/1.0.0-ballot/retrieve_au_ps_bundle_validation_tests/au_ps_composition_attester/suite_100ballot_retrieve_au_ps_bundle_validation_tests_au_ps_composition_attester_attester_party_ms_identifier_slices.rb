...
module AUPSTestKit
  ...
  class AUPSSuite100ballotRetrieveAuPsBundleValidationTestsAuPsCompositionAttesterMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :suite_100ballot_retrieve_au_ps_bundle_validation_tests_au_ps_composition_attester_attester_party_ms_identifier_slices
