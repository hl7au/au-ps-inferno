...
require_relative 'au_ps_composition_optional_sections/suite_100ballot_retrieve_au_ps_bundle_validation_tests_au_ps_composition_optional_sections_sections_may_be_correctly_populated_if_a_value_is_known'
...
module AUPSTestKit
  ...
  class AUPSSuite100ballotRetrieveAuPsBundleValidationTestsAuPsCompositionOptionalSections < Inferno::TestGroup
    ...
    test from: :suite_100ballot_retrieve_au_ps_bundle_validation_tests_au_ps_composition_optional_sections_sections_may_be_correctly_populated_if_a_value_is_known
