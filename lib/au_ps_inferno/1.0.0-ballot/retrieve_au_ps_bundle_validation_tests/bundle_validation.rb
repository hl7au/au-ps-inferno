...
module AUPSTestKit
  ...
  class AUPSSuiteRetrieveAuPsBundleValidationTestsBundleValidation100ballot < Inferno::TestGroup
    title 'Bundle Validation'
    description 'Validates that the bundle conforms to the Bundle profiles.'
    id :suite_retrieve_au_ps_bundle_validation_tests_bundle_validation_100ballot

    run_as_group

    test from: :suite_retrieve_au_ps_bundle_validation_tests_bundle_validation_bundle_valid_100ballot

    test from: :suite_retrieve_au_ps_bundle_validation_tests_bundle_validation_bundle_valid_ips_100ballot
  end
end
