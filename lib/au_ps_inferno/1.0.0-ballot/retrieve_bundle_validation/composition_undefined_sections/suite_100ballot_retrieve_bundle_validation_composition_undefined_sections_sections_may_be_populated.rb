...
module AUPSTestKit
  ...
  class AUPSSuite100ballotRetrieveBundleValidationCompositionUndefinedSectionsSectionsMayBePopulated < BasicTest
    title 'Sections MAY be populated'
    description ''
    id :suite_100ballot_retrieve_bundle_validation_composition_undefined_sections_sections_may_be_populated
