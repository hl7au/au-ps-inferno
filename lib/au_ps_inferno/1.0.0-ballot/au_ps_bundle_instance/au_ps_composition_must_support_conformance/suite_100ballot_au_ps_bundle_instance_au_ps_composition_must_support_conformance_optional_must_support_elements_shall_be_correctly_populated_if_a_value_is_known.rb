...
module AUPSTestKit
  ...
  class AUPSSuite100ballotAuPsBundleInstanceAuPsCompositionMustSupportConformanceOptionalMustSupportElementsShallBeCorrectlyPopulatedIfAValueIsKnown < BasicTest
    ...
    id :suite_100ballot_au_ps_bundle_instance_au_ps_composition_must_support_conformance_optional_must_support_elements_shall_be_correctly_populated_if_a_value_is_known
