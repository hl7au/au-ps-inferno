...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceAuPsCompositionAttester100ballot < Inferno::TestGroup
    ...
    id :suite_au_ps_bundle_instance_au_ps_composition_attester_100ballot

    optional

    run_as_group

    test from: :suite_au_ps_bundle_instance_au_ps_composition_attester_attester_party_ms_elements_100ballot

    test from: :suite_au_ps_bundle_instance_au_ps_composition_attester_attester_party_ms_subelements_100ballot

    test from: :suite_au_ps_bundle_instance_au_ps_composition_attester_attester_party_ms_identifier_slices_100ballot
  end
end
