...
module AUPSTestKit
  ...
  class AUPSSuite100ballotAuPsBundleInstanceAuPsCompositionSubjectMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :suite_100ballot_au_ps_bundle_instance_au_ps_composition_subject_subject_ms_identifier_slices
