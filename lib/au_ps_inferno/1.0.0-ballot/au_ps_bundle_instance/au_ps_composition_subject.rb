...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceAuPsCompositionSubject100ballot < Inferno::TestGroup
    title 'AU PS Composition Subject'
    description 'Verify the referenced subject is a correctly populated AU PS Patient resource.'
    id :suite_au_ps_bundle_instance_au_ps_composition_subject_100ballot

    run_as_group

    test from: :suite_au_ps_bundle_instance_au_ps_composition_subject_subject_resource_type_is_valid_100ballot

    test from: :suite_au_ps_bundle_instance_au_ps_composition_subject_subject_ms_elements_100ballot

    test from: :suite_au_ps_bundle_instance_au_ps_composition_subject_subject_ms_subelements_populated_100ballot

    test from: :suite_au_ps_bundle_instance_au_ps_composition_subject_subject_ms_identifier_slices_100ballot
  end
end
