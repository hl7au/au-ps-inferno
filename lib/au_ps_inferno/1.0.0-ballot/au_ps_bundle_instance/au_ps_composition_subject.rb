...
require_relative 'au_ps_composition_subject/suite_100ballot_au_ps_bundle_instance_au_ps_composition_subject_subject_resource_type_is_valid'
...
require_relative 'au_ps_composition_subject/suite_100ballot_au_ps_bundle_instance_au_ps_composition_subject_subject_ms_identifier_slices'


module AUPSTestKit
  # Automatically generated primitive group for AU PS Composition Subject
  class AUPSSuite100ballotAuPsBundleInstanceAuPsCompositionSubject < Inferno::TestGroup
    title 'AU PS Composition Subject'
    description 'Verify the referenced subject is a correctly populated AU PS Patient resource.'
    id :suite_100ballot_au_ps_bundle_instance_au_ps_composition_subject
    ...
    test from: :suite_100ballot_au_ps_bundle_instance_au_ps_composition_subject_subject_resource_type_is_valid
    ...
    test from: :suite_100ballot_au_ps_bundle_instance_au_ps_composition_subject_subject_ms_identifier_slices
