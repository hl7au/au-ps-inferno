...
require_relative 'au_ps_composition_recommended_sections/suite_100ballot_au_ps_bundle_instance_au_ps_composition_recommended_sections_sections_should_be_correctly_populated_if_a_value_is_known'
...
module AUPSTestKit
  ...
  class AUPSSuite100ballotAuPsBundleInstanceAuPsCompositionRecommendedSections < Inferno::TestGroup
    ...
    test from: :suite_100ballot_au_ps_bundle_instance_au_ps_composition_recommended_sections_sections_should_be_correctly_populated_if_a_value_is_known
