...
module AUPSTestKit
  ...
  class IpsSummaryCompositionMustSupportConformanceOptionalMustSupportElementsAreCorrectlyPopulated < BasicTest
    ...
    id :ips_summary_composition_must_support_conformance_composition_optional_ms_populated
