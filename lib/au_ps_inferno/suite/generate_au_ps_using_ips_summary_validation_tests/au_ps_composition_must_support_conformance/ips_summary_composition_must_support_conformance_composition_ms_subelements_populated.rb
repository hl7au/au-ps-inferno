...
module AUPSTestKit
  ...
  class IpsSummaryCompositionMustSupportConformanceMustSupportSubelementsOfAComplexElementAreCorrectlyPopulated < BasicTest
    ...
    id :ips_summary_composition_must_support_conformance_composition_ms_subelements_populated
