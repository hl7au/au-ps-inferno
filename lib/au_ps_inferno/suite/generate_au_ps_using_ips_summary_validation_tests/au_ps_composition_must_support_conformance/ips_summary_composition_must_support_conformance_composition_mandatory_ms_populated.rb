...
module AUPSTestKit
  ...
  class IpsSummaryCompositionMustSupportConformanceMandatoryMustSupportElementsAreCorrectlyPopulated < BasicTest
    ...
    id :ips_summary_composition_must_support_conformance_composition_mandatory_ms_populated
