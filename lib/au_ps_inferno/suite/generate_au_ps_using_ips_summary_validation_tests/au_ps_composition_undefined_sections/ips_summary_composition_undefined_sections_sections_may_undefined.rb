...
module AUPSTestKit
  ...
  class IpsSummaryCompositionUndefinedSectionsUndefinedSectionsAreCorrectlyPopulated < BasicTest
    title 'Undefined sections are correctly populated'
    description 'Undefined sections MAY be populated if a value is known'
    id :ips_summary_composition_undefined_sections_sections_may_undefined
