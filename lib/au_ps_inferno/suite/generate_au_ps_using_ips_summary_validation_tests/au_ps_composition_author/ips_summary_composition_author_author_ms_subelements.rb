...
module AUPSTestKit
  ...
  class IpsSummaryCompositionAuthorMustSupportSubelementsShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :ips_summary_composition_author_author_ms_subelements
