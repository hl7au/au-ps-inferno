...
module AUPSTestKit
  ...
  class IpsSummaryCompositionAuthorAuthorReferenceInTheCompositionShallResolveToAValidResourceTypePractitionerPractitionerroleDevicePatientRelatedpersonOrganization < BasicTest
    ...
    id :ips_summary_composition_author_author_resource_type_is_valid
