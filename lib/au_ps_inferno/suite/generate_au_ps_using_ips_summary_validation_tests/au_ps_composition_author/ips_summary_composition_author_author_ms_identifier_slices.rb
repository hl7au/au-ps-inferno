...
module AUPSTestKit
  ...
  class IpsSummaryCompositionAuthorMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :ips_summary_composition_author_author_ms_identifier_slices
