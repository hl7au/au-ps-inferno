...
module AUPSTestKit
  ...
  class IpsSummaryBundleMustSupportConformanceBundleMustSupportElementsAreCorrectlyPopulated < BasicTest
    ...
    id :ips_summary_bundle_must_support_conformance_bundle_must_support_populated
