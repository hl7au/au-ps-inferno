...
module AUPSTestKit
  ...
  class IpsSummaryCompositionMandatorySectionsCompositionMandatorySectionsCapableOfPopulatingReferencedProfiles < BasicTest
    ...
    id :ips_summary_composition_mandatory_sections_mandatory_sections_entry_profiles
