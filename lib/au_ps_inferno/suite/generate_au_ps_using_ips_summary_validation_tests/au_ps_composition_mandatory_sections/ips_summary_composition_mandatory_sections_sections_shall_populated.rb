...
module AUPSTestKit
  ...
  class IpsSummaryCompositionMandatorySectionsCompositionMandatorySectionsAreCorrectlyPopulated < BasicTest
    ...
    id :ips_summary_composition_mandatory_sections_sections_shall_populated
