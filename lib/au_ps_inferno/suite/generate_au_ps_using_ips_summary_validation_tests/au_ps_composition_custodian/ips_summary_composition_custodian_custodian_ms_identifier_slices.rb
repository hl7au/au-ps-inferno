...
module AUPSTestKit
  ...
  class IpsSummaryCompositionCustodianMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :ips_summary_composition_custodian_custodian_ms_identifier_slices
