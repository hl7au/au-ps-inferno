...
module AUPSTestKit
  ...
  class IpsSummaryCompositionCustodianMustSupportSubelementShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :ips_summary_composition_custodian_custodian_ms_subelements
