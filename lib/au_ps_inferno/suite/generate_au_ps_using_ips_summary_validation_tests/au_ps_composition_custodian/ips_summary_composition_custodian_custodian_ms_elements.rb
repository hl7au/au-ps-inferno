...
module AUPSTestKit
  ...
  class IpsSummaryCompositionCustodianMustSupportElementShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :ips_summary_composition_custodian_custodian_ms_elements
