...
module AUPSTestKit
  ...
  class IpsSummaryBundleValidationGeneratedBundleIsValidAgainstIpsBundleProfile < IpsSummaryValidBundleClass
    ...
    id :ips_summary_bundle_validation_bundle_valid_ips
