...
module AUPSTestKit
  ...
  class IpsSummaryCompositionRecommendedSectionsCompositionRecommendedSectionsAreCorrectlyPopulated < BasicTest
    ...
    id :ips_summary_composition_recommended_sections_sections_should_populated
