...
module AUPSTestKit
  ...
  class IpsSummaryCompositionSubjectMustSupportSubelementShallBePopulatedIfAValueIsKnownAndTheParentIsPopulated < BasicTest
    ...
    id :ips_summary_composition_subject_subject_ms_subelements_populated
