...
module AUPSTestKit
  ...
  class IpsSummaryCompositionSubjectSubjectReferenceInTheCompositionShallResolveToAValidResourceTypePatient < BasicTest
    ...
    id :ips_summary_composition_subject_subject_resource_type_is_valid
