...
module AUPSTestKit
  ...
  class IpsSummaryCompositionSubjectMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :ips_summary_composition_subject_subject_ms_identifier_slices
