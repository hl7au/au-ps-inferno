...
module AUPSTestKit
  ...
  class AUPSSuiteGenerateAuPsUsingIpsSummaryValidationTestsAuPsCompositionSubjectMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :suite_generate_au_ps_using_ips_summary_validation_tests_au_ps_composition_subject_subject_ms_identifier_slices
