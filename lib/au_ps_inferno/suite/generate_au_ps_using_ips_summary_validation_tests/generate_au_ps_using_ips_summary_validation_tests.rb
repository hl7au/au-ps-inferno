...
module AUPSTestKit
  ...
  class AUPSSuite100previewGenerateAuPsUsingIpsSummaryValidationTests < Inferno::TestGroup
    ...
    group from: :suite_100preview_generate_au_ps_using_ips_summary_validation_tests_bundle_validation
    
    group from: :suite_100preview_generate_au_ps_using_ips_summary_validation_tests_au_ps_bundle_must_support_conformance
    
    group from: :suite_100preview_generate_au_ps_using_ips_summary_validation_tests_au_ps_composition_must_support_conformance
