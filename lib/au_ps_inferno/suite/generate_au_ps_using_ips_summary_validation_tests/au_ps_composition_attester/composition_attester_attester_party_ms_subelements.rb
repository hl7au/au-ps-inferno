...
module AUPSTestKit
  ...
  class AUPSSuiteGenerateAuPsUsingIpsSummaryValidationTestsAuPsCompositionAttesterMustSupportSubelementShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :suite_generate_au_ps_using_ips_summary_validation_tests_au_ps_composition_attester_attester_party_ms_subelements
