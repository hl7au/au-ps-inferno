...
module AUPSTestKit
  ...
  class IpsSummaryCompositionAttesterMustSupportElementsShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :ips_summary_composition_attester_attester_party_ms_elements
