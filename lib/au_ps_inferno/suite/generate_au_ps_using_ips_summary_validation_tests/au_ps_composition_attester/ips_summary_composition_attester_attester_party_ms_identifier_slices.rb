...
module AUPSTestKit
  ...
  class IpsSummaryCompositionAttesterMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :ips_summary_composition_attester_attester_party_ms_identifier_slices
