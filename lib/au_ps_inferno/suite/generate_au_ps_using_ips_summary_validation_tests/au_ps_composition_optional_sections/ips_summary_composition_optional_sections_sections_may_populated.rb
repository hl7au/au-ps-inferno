...
module AUPSTestKit
  ...
  class IpsSummaryCompositionOptionalSectionsCompositionOptionalSectionsAreCorrectlyPopulated < BasicTest
    ...
    id :ips_summary_composition_optional_sections_sections_may_populated
