...
module AUPSTestKit
  ...
  class IpsSummaryCompositionOptionalSectionsCompositionOptionalSectionsCapableOfPopulatingReferencedProfiles < BasicTest
    ...
    id :ips_summary_composition_optional_sections_optional_sections_entry_profiles
    optional
