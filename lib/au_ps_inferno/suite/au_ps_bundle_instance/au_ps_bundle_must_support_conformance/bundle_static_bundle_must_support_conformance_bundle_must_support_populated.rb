...
module AUPSTestKit
  ...
  class BundleStaticBundleMustSupportConformanceBundleMustSupportElementsAreCorrectlyPopulated < BasicTest
    ...
    id :bundle_static_bundle_must_support_conformance_bundle_must_support_populated
