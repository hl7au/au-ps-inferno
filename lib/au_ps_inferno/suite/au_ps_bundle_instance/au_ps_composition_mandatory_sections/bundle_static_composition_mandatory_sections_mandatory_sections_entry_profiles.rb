...
module AUPSTestKit
  ...
  class BundleStaticCompositionMandatorySectionsCompositionMandatorySectionsCapableOfPopulatingReferencedProfiles < BasicTest
    ...
    id :bundle_static_composition_mandatory_sections_mandatory_sections_entry_profiles
