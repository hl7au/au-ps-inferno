...
module AUPSTestKit
  ...
  class BundleStaticCompositionMandatorySectionsCompositionMandatorySectionsAreCorrectlyPopulated < BasicTest
    ...
    id :bundle_static_composition_mandatory_sections_sections_shall_populated
