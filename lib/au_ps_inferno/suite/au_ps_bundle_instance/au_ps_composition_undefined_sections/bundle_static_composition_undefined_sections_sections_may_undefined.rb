...
module AUPSTestKit
  ...
  class BundleStaticCompositionUndefinedSectionsUndefinedSectionsAreCorrectlyPopulated < BasicTest
    title 'Undefined sections are correctly populated'
    description 'Undefined sections MAY be populated if a value is known'
    id :bundle_static_composition_undefined_sections_sections_may_undefined
