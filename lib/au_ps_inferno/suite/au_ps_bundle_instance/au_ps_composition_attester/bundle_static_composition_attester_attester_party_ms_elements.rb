...
module AUPSTestKit
  ...
  class BundleStaticCompositionAttesterMustSupportElementsShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_static_composition_attester_attester_party_ms_elements
