...
module AUPSTestKit
  ...
  class BundleStaticCompositionAttesterMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_static_composition_attester_attester_party_ms_identifier_slices
