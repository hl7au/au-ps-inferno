...
module AUPSTestKit
  ...
  class BundleStaticCompositionAttesterMustSupportSubelementShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_static_composition_attester_attester_party_ms_subelements
