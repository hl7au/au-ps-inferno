...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceAuPsCompositionAttester < Inferno::TestGroup
    ...
    id :suite_au_ps_bundle_instance_au_ps_composition_attester

    optional

    run_as_group

    test from: :suite_au_ps_bundle_instance_au_ps_composition_attester_attester_party_ms_elements

    test from: :suite_au_ps_bundle_instance_au_ps_composition_attester_attester_party_ms_subelements

    test from: :suite_au_ps_bundle_instance_au_ps_composition_attester_attester_party_ms_identifier_slices
  end
end
