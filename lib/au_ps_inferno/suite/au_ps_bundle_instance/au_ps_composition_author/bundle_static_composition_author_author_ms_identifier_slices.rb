...
module AUPSTestKit
  ...
  class BundleStaticCompositionAuthorMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_static_composition_author_author_ms_identifier_slices
