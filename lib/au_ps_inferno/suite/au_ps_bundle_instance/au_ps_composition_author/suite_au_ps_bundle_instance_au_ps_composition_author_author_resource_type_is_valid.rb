...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceAuPsCompositionAuthorAuthorReferenceInTheAuPsCompositionShallResolveToAValidResourceTypePractitionerPractitionerroleDevicePatientRelatedpersonOrganization < BasicTest
    ...
    id :suite_au_ps_bundle_instance_au_ps_composition_author_author_resource_type_is_valid
