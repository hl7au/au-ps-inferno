...
module AUPSTestKit
  ...
  class BundleStaticCompositionAuthorAuthorReferenceInTheCompositionShallResolveToAValidResourceTypePractitionerPractitionerroleDevicePatientRelatedpersonOrganization < BasicTest
    ...
    id :bundle_static_composition_author_author_resource_type_is_valid
