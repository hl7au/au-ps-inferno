...
module AUPSTestKit
  ...
  class BundleStaticCompositionAuthorMustSupportSubelementsShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_static_composition_author_author_ms_subelements
