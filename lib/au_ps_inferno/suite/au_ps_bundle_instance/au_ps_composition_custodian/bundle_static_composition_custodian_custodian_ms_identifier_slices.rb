...
module AUPSTestKit
  ...
  class BundleStaticCompositionCustodianMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_static_composition_custodian_custodian_ms_identifier_slices
