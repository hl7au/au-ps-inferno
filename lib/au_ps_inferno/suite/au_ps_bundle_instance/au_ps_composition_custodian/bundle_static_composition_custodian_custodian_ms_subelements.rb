...
module AUPSTestKit
  ...
  class BundleStaticCompositionCustodianMustSupportSubelementShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_static_composition_custodian_custodian_ms_subelements
