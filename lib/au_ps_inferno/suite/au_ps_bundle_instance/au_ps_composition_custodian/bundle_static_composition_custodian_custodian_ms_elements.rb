...
module AUPSTestKit
  ...
  class BundleStaticCompositionCustodianMustSupportElementShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_static_composition_custodian_custodian_ms_elements
