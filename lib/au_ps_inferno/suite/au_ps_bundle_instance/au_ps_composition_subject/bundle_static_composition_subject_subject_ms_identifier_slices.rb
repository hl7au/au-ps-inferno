...
module AUPSTestKit
  ...
  class BundleStaticCompositionSubjectMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_static_composition_subject_subject_ms_identifier_slices
