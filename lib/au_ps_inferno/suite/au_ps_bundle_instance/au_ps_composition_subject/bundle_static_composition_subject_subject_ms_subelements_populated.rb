...
module AUPSTestKit
  ...
  class BundleStaticCompositionSubjectMustSupportSubelementShallBePopulatedIfAValueIsKnownAndTheParentIsPopulated < BasicTest
    ...
    id :bundle_static_composition_subject_subject_ms_subelements_populated
