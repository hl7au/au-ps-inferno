...
module AUPSTestKit
  ...
  class BundleStaticCompositionSubjectSubjectReferenceInTheCompositionShallResolveToAValidResourceTypePatient < BasicTest
    ...
    id :bundle_static_composition_subject_subject_resource_type_is_valid
