...
module AUPSTestKit
  ...
  class BundleStaticCompositionOptionalSectionsCompositionOptionalSectionsCapableOfPopulatingReferencedProfiles < BasicTest
    ...
    id :bundle_static_composition_optional_sections_optional_sections_entry_profiles
    optional
