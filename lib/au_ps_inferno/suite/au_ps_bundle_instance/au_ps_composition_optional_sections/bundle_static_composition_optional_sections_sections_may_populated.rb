...
module AUPSTestKit
  ...
  class BundleStaticCompositionOptionalSectionsCompositionOptionalSectionsAreCorrectlyPopulated < BasicTest
    ...
    id :bundle_static_composition_optional_sections_sections_may_populated
