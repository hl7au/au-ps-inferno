...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceAuPsCompositionOptionalSectionsAuPsCompositionOptionalSectionsCapableOfPopulatingReferencedProfiles < BasicTest
    ...
    id :suite_au_ps_bundle_instance_au_ps_composition_optional_sections_optional_sections_entry_profiles
