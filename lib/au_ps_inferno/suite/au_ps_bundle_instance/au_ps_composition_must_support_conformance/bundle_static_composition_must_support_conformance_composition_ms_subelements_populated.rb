...
module AUPSTestKit
  ...
  class BundleStaticCompositionMustSupportConformanceMustSupportSubelementsOfAComplexElementAreCorrectlyPopulated < BasicTest
    ...
    id :bundle_static_composition_must_support_conformance_composition_ms_subelements_populated
