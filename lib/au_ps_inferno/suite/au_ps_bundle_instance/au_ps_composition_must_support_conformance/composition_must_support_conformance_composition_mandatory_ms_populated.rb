...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceAuPsCompositionMustSupportConformanceMandatoryMustSupportElementsAreCorrectlyPopulated < BasicTest
    ...
    id :suite_au_ps_bundle_instance_au_ps_composition_must_support_conformance_composition_mandatory_ms_populated
