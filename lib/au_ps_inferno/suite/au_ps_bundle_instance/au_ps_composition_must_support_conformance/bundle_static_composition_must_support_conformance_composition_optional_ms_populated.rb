...
module AUPSTestKit
  ...
  class BundleStaticCompositionMustSupportConformanceOptionalMustSupportElementsAreCorrectlyPopulated < BasicTest
    ...
    id :bundle_static_composition_must_support_conformance_composition_optional_ms_populated
