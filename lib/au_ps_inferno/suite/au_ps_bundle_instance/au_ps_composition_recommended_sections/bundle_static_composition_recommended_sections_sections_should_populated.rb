...
module AUPSTestKit
  ...
  class BundleStaticCompositionRecommendedSectionsCompositionRecommendedSectionsAreCorrectlyPopulated < BasicTest
    ...
    id :bundle_static_composition_recommended_sections_sections_should_populated
