...
module AUPSTestKit
  ...
  class BundleStaticCompositionRecommendedSectionsCompositionRecommendedSectionsCapableOfPopulatingReferencedProfiles < BasicTest
    ...
    id :bundle_static_composition_recommended_sections_recommended_sections_entry_profiles
