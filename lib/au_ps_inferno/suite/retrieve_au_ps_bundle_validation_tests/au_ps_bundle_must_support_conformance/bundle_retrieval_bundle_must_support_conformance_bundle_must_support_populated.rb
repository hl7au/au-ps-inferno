...
module AUPSTestKit
  ...
  class BundleRetrievalBundleMustSupportConformanceBundleMustSupportElementsAreCorrectlyPopulated < BasicTest
    ...
    id :bundle_retrieval_bundle_must_support_conformance_bundle_must_support_populated
