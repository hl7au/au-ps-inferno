...
module AUPSTestKit
  ...
  class AUPSSuiteRetrieveAuPsBundleValidationTestsAuPsCompositionUndefinedSections < Inferno::TestGroup
    ...
    id :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_undefined_sections

    optional

    run_as_group

    test from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_undefined_sections_sections_may_undefined
  end
end
