...
module AUPSTestKit
  ...
  class AUPSSuite100previewRetrieveAuPsBundleValidationTestsAuPsCompositionRecommendedSectionsAuPsCompositionRecommendedSectionsCapableOfPopulatingReferencedProfiles < BasicTest
    ...
    id :suite_100preview_retrieve_au_ps_bundle_validation_tests_au_ps_composition_recommended_sections_recommended_sections_entry_profiles
