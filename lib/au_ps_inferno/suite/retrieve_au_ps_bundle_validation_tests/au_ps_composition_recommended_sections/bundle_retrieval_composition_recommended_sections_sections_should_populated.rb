...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionRecommendedSectionsCompositionRecommendedSectionsAreCorrectlyPopulated < BasicTest
    ...
    id :bundle_retrieval_composition_recommended_sections_sections_should_populated
