...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionRecommendedSectionsCompositionRecommendedSectionsCapableOfPopulatingReferencedProfiles < BasicTest
    ...
    id :bundle_retrieval_composition_recommended_sections_recommended_sections_entry_profiles
