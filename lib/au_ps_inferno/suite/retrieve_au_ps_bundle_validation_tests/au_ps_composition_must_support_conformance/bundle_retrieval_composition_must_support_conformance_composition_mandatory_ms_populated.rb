...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionMustSupportConformanceMandatoryMustSupportElementsAreCorrectlyPopulated < BasicTest
    ...
    id :bundle_retrieval_composition_must_support_conformance_composition_mandatory_ms_populated
