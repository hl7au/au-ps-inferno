...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionMustSupportConformanceMustSupportSubelementsOfAComplexElementAreCorrectlyPopulated < BasicTest
    ...
    id :bundle_retrieval_composition_must_support_conformance_composition_ms_subelements_populated
