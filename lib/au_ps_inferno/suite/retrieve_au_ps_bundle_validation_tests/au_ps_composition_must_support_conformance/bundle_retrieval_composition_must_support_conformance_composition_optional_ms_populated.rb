...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionMustSupportConformanceOptionalMustSupportElementsAreCorrectlyPopulated < BasicTest
    ...
    id :bundle_retrieval_composition_must_support_conformance_composition_optional_ms_populated
