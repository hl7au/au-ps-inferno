...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionAttesterMustSupportSubelementShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_retrieval_composition_attester_attester_party_ms_subelements
