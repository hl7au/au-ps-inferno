...
module AUPSTestKit
  ...
  class AUPSSuiteRetrieveAuPsBundleValidationTestsAuPsBundleMustSupportConformance < Inferno::TestGroup
    ...
    id :suite_retrieve_au_ps_bundle_validation_tests_au_ps_bundle_must_support_conformance

    run_as_group

    test from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_bundle_must_support_conformance_bundle_must_support_populated
  end
end
