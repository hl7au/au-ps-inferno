...
module AUPSTestKit
  ...
  class AUPSSuite100previewRetrieveAuPsBundleValidationTestsBundleValidationRetrievedBundleIsValidAgainstAuPsBundleProfile < RetrieveBundleTestClass
    ...
    id :suite_100preview_retrieve_au_ps_bundle_validation_tests_bundle_validation_bundle_valid
