...
module AUPSTestKit
  ...
  class BundleRetrievalBundleValidationRetrievedBundleIsValidAgainstIpsBundleProfile < IpsRetrieveBundleTestClass
    ...
    id :bundle_retrieval_bundle_validation_bundle_valid_ips
