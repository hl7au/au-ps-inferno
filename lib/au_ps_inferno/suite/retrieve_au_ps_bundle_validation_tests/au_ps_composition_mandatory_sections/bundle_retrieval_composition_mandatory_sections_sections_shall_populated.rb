...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionMandatorySectionsCompositionMandatorySectionsAreCorrectlyPopulated < BasicTest
    ...
    id :bundle_retrieval_composition_mandatory_sections_sections_shall_populated
