...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionMandatorySectionsCompositionMandatorySectionsCapableOfPopulatingReferencedProfiles < BasicTest
    ...
    id :bundle_retrieval_composition_mandatory_sections_mandatory_sections_entry_profiles
