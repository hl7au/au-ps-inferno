...
module AUPSTestKit
  ...
  class AUPSSuite100previewRetrieveAuPsBundleValidationTestsAuPsCompositionAuthorMustSupportSubelementsShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :suite_100preview_retrieve_au_ps_bundle_validation_tests_au_ps_composition_author_author_ms_subelements
