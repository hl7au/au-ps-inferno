...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionAuthorAuthorReferenceInTheCompositionShallResolveToAValidResourceTypePractitionerPractitionerroleDevicePatientRelatedpersonOrganization < BasicTest
    ...
    id :bundle_retrieval_composition_author_author_resource_type_is_valid
