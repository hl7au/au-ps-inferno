...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionAuthorMustSupportSubelementsShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_retrieval_composition_author_author_ms_subelements
