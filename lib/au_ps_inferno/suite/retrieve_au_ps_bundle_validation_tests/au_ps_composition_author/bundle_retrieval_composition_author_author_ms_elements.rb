...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionAuthorMustSupportElementsShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_retrieval_composition_author_author_ms_elements
