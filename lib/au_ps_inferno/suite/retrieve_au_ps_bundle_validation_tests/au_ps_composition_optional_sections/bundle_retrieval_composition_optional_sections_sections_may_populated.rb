...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionOptionalSectionsCompositionOptionalSectionsAreCorrectlyPopulated < BasicTest
    ...
    id :bundle_retrieval_composition_optional_sections_sections_may_populated
