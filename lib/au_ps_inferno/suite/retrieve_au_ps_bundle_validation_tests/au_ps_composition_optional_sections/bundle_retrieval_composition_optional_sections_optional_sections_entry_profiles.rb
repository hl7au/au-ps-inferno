...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionOptionalSectionsCompositionOptionalSectionsCapableOfPopulatingReferencedProfiles < BasicTest
    ...
    id :bundle_retrieval_composition_optional_sections_optional_sections_entry_profiles
    optional
