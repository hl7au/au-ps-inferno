...
module AUPSTestKit
  ...
  class AUPSSuite100previewRetrieveAuPsBundleValidationTestsAuPsCompositionOptionalSectionsAuPsCompositionOptionalSectionsAreCorrectlyPopulated < BasicTest
    ...
    id :suite_100preview_retrieve_au_ps_bundle_validation_tests_au_ps_composition_optional_sections_sections_may_populated
