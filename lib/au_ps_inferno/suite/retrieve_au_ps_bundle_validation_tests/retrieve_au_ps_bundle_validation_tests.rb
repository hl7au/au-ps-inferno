...
module AUPSTestKit
  ...
  class AUPSSuiteRetrieveAuPsBundleValidationTests < Inferno::TestGroup
    ...
    group from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_bundle_must_support_conformance

    group from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_must_support_conformance

    group from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_mandatory_sections

    group from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_recommended_sections

    group from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_optional_sections

    group from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_undefined_sections

    group from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_subject

    group from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_author

    group from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_custodian

    group from: :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_attester
  end
end
