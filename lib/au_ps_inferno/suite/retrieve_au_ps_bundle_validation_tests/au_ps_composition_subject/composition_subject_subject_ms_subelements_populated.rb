...
module AUPSTestKit
  ...
  class AUPSSuiteRetrieveAuPsBundleValidationTestsAuPsCompositionSubjectMustSupportSubelementShallBePopulatedIfAValueIsKnownAndTheParentIsPopulated < BasicTest
    ...
    id :suite_retrieve_au_ps_bundle_validation_tests_au_ps_composition_subject_subject_ms_subelements_populated
