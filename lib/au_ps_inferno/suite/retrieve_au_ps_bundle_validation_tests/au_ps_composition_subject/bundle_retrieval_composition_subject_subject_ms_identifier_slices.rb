...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionSubjectMustSupportIdentifierSlicesShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_retrieval_composition_subject_subject_ms_identifier_slices
