...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionSubjectSubjectReferenceInTheCompositionShallResolveToAValidResourceTypePatient < BasicTest
    ...
    id :bundle_retrieval_composition_subject_subject_resource_type_is_valid
