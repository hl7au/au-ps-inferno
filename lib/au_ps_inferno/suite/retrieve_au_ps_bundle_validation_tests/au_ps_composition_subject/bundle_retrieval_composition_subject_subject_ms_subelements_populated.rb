...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionSubjectMustSupportSubelementShallBePopulatedIfAValueIsKnownAndTheParentIsPopulated < BasicTest
    ...
    id :bundle_retrieval_composition_subject_subject_ms_subelements_populated
