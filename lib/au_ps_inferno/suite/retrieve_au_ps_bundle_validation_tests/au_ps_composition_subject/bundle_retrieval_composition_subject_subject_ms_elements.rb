...
module AUPSTestKit
  ...
  class BundleRetrievalCompositionSubjectMustSupportElementsShallBePopulatedIfAValueIsKnown < BasicTest
    ...
    id :bundle_retrieval_composition_subject_subject_ms_elements
