...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceAuPsBundleMustSupportConformance < Inferno::TestGroup
    ...
    id :suite_au_ps_bundle_instance_au_ps_bundle_must_support_conformance

    run_as_group

    test from: :suite_au_ps_bundle_instance_au_ps_bundle_must_support_conformance_bundle_must_support_populated
  end
end
