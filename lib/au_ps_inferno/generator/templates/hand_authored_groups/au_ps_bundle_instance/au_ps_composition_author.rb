...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceAuPsCompositionAuthor < Inferno::TestGroup
    ...
    id :suite_au_ps_bundle_instance_au_ps_composition_author

    run_as_group

    test from: :suite_au_ps_bundle_instance_au_ps_composition_author_author_resource_type_is_valid

    test from: :suite_au_ps_bundle_instance_au_ps_composition_author_author_ms_elements

    test from: :suite_au_ps_bundle_instance_au_ps_composition_author_author_ms_subelements

    test from: :suite_au_ps_bundle_instance_au_ps_composition_author_author_ms_identifier_slices
  end
end
