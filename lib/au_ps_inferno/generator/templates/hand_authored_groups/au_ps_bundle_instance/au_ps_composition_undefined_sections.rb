...
module AUPSTestKit
  ...
  class AUPSSuiteAuPsBundleInstanceAuPsCompositionUndefinedSections < Inferno::TestGroup
    ...
    id :suite_au_ps_bundle_instance_au_ps_composition_undefined_sections

    optional

    run_as_group

    test from: :suite_au_ps_bundle_instance_au_ps_composition_undefined_sections_sections_may_undefined
  end
end
