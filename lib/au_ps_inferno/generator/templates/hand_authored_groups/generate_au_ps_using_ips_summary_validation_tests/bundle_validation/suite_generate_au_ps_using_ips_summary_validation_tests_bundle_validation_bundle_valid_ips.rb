...
module AUPSTestKit
  ...
  class AUPSSuiteGenerateAuPsUsingIpsSummaryValidationTestsBundleValidationGeneratedBundleIsValidAgainstIpsBundleProfile < IpsSummaryValidBundleClass
    ...
    id :suite_generate_au_ps_using_ips_summary_validation_tests_bundle_validation_bundle_valid_ips
