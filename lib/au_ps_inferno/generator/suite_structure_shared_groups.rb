  ...
  module SuiteStructure
    ...
    SHARED_GROUP_DEFINITIONS = [
      ...
      },
      {
        ...
        tests: [{ id: :bundle_must_support_populated }],
        run_as_group: true
      },
      {
      ...
      },
      {
        ...
        tests: [{ id: :sections_shall_populated }, { id: :sections_entry_profiles }],
        run_as_group: true
      },
      {
        ...
        tests: [{ id: :sections_should_populated }],
        run_as_group: true
      },
      {
        ...
        tests: [{ id: :sections_may_populated }],
        run_as_group: true
      },
      {
        ...
        tests: [{ id: :sections_may_undefined }],
        optional: true,
        run_as_group: true
      },
      {
