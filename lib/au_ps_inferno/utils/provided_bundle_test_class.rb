...
module AUPSTestKit
  ...
  class ProvidedBundleTestClass < BasicTest
    ...
    NOT_SELECTED_METHOD_MESSAGE = "The 'JSON file' retrieval method was not selected, so this test is omitted."
    ...
    run do
      omit_if retrieval_method != 'json_file', NOT_SELECTED_METHOD_MESSAGE
