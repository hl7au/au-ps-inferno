...
module AUPSTestKit
  ...
  class AUPSSectionsAlertsValidation < SectionTest
    title 'Validate ALERT Section References and Resources'
    description 'Validates that the ALERTS section in the Composition resource contains valid references that resolve to expected resource types in the bundle, and that each referenced resource conforms to its specified FHIR profile(s).'
