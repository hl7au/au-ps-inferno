...
module AUPSTestKit
  ...
  class AUPSSectionsSocialHistoryValidation050preview < BasicTest
    ...
    id :au_ps_sections_social_history_validation_050preview
    optional true
    ...
    run do
      ...
      read_and_save_data
      validate_section_resources('SOCIAL_HISTORY_NOTE')
    end
  end
end
