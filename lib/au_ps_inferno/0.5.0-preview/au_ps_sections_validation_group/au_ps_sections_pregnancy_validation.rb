...
module AUPSTestKit
  ...
  class AUPSSectionsPregnancyValidation050preview < BasicTest
    title 'Validate HISTORY OF PREGNANCIES NARRATIVE Section References and Resources'
    description 'Validates that the HISTORY OF PREGNANCIES NARRATIVE section in the Composition resource ' \
    ...
    id :au_ps_sections_pregnancy_validation_050preview
    optional true
