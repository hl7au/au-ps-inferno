...
module AUPSTestKit
  ...
  class AUPSSectionsFunctionalStatusValidation050preview < BasicTest
    title 'Validate FUNCTIONAL STATUS ASSESSMENT NOTE Section References and Resources'
    description 'Validates that the FUNCTIONAL STATUS ASSESSMENT NOTE section in the Composition resource ' \
    ...
    id :au_ps_sections_functional_status_validation_050preview
    optional true
