...
module AUPSTestKit
  ...
  class AUPSSectionsMedicationsValidation050preview < BasicTest
    ...
    id :au_ps_sections_medications_validation_050preview
    ...
    run do
      ...
      read_and_save_data
      validate_section_resources('HISTORY_OF_MEDICATION_USE_NARRATIVE')
    end
  end
end
