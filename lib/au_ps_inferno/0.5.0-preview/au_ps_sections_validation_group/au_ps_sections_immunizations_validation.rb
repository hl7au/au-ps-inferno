...
module AUPSTestKit
  ...
  class AUPSSectionsImmunizationValidation050preview < BasicTest
    ...
    id :au_ps_sections_immunizations_validation_050preview
    optional true
    ...
    run do
      ...
      read_and_save_data
      validate_section_resources('HISTORY_OF_IMMUNIZATION_NOTE')
    end
  end
end
