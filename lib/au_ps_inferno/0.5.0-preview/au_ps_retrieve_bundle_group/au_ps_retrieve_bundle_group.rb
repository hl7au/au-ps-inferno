...
module AUPSTestKit
  ...
  class AUPSRetrieveBundleGroup050preview < Inferno::TestGroup
    extend Constants
    ...
    id :au_ps_retrieve_bundle_group_050preview

    run_as_group

    test from: :au_ps_retrieve_valid_bundle_050preview
    test from: :au_ps_retrieve_bundle_has_must_support_elements_050preview
    test from: :au_ps_retrieve_bundle_composition_must_support_elements_050preview
    test from: :au_ps_retrieve_bundle_composition_mandatory_sections_050preview
    test from: :au_ps_retrieve_bundle_composition_recommended_sections_050preview
    test from: :au_ps_retrieve_bundle_composition_optional_sections_050preview
    test from: :au_ps_retrieve_bundle_composition_other_sections_050preview
  end
end
